...
class FireBaseStorage {
  ...
  static Future<firebase_storage.Reference?> saveAvatar(
    ...
    try {
      ...
      print.call("Reference: ${result.ref}");
      return result.ref;
    } on firebase_storage.FirebaseException catch (e) {
      print.call('Failed to save avatar');
      print.call(() => log(e.code));
      return null;
    }
  }
  ...
  static Future<String> uploadFile(File _image, String uid, int index) async {
    ...
    final firebase_storage.Reference storageReference =
        _instance.ref("$_reviews${uid}_$index$extension");
  ...
  static Future<List<String>> uploadFilesAndGetUrls(
      List<File> _images, String uid) async {
    int index = 0;
  ...
  static Future<String?> getAvatar(String ref) async {
    try {
      ...
      print.call('Url : $results');
      return results;
    } on firebase_storage.FirebaseException catch (e) {
      print.call('Failed to get avatar url');
      print.call(() => log(e.code));
      return null;
    }
  }
